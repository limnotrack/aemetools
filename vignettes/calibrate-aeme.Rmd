...
the `run_aeme` function in that it does not return an `aeme` object, but
...
sim_id <- calib_aeme(aeme = aeme, path = path,
                     ...
                     model_controls = model_controls, FUN_list = FUN_list,
                     ctrl = ctrl, vars_sim = vars_sim, weights = weights)
...
aeme <- run_aeme_param(aeme = aeme, path = path,
                            ...
                            model_controls = model_controls, return_aeme = TRUE)
