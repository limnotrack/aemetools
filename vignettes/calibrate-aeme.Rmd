...
example, we will use the `glm_aed` model. The `build_aeme` function will build the model setup and the `run_aeme` function will run the model. The model output is stored in the lake folder.
