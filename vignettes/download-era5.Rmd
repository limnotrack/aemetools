...
#### Example: Download 2m air temperature for January 2024 for Lake Toba, Indonesia
...
the years 2000-2001. We can use the `get_era5_point()` function to download the
data.
