...
# Build a run directory with a prior (iteration 0) and posterior
# (iteration 2) ensemble. The posterior is deliberately much narrower for
# p001 and identical in width for p002, so variance reduction has a known
# answer.
